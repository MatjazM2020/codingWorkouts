...
# end of the line, the direction changes, and people continue passing the pillow
# in the opposite direction.For example, once the pillow reaches the nth person they pass
# it to the n - 1th person, then to the n - 2th person and so on. 
