with cte as (select
    greatest(user1_id, user2_id) id
from Friendship
where user1_id = 1 or user2_id = 1)
select 
    distinct page_id recommended_page
from Likes l 
inner join cte on cte.id = l.user_id
...
/*
https://leetcode.com/problems/page-recommendations/description/?envType=study-plan-v2&envId=premium-sql-50
