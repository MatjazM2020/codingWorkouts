...
from Orders o
inner join Customers c using (customer_id)) x
where rk <= 3
...
/*
https://leetcode.com/problems/the-most-recent-three-orders/description/?envType=study-plan-v2&envId=premium-sql-50
